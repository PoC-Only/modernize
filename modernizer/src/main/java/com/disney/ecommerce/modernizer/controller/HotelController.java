...
public class HotelController {
	...
	public ResponseEntity<?> getAllHotels(@RequestHeader(value = "Authorization") String auth,
			...
			@RequestParam(required = false) Integer number_adults,
			@RequestParam(required = false) Integer number_children,
			@RequestParam(required = false) Integer number_infants,
	...
	public ResponseEntity<?> getHotelPackage(@RequestHeader(value = "Authorization") String auth,
			...
			@RequestParam Integer number_adults,
			@RequestParam Integer number_children,
